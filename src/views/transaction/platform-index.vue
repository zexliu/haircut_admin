  ...
  <div class="app-container">
    ...
    <div class="table-container">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-tag v-if="scope.row.type === 'GROUP_INCOME'">团购收入</el-tag>
            <el-tag v-if="scope.row.type === 'SERVICE_INCOME'" type="success">服务收入</el-tag>
            <el-tag v-if="scope.row.type === 'WITHDRAW'" type="danger">支出</el-tag>
          </template>
        </el-table-column>
...
<script>
import { fetchList } from '@/api/platform-transaction'
