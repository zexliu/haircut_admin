    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="操作" width="200" align="center">
          <template slot-scope="scope">
            <router-link :to="'/rbac/modules/update/'+scope.row.id">
...
<script>
import { fetchList, remove } from '@/api/permission-module'
...
export default {
  ...
  methods: {
    ...
    recursiveData(list, parentId) {
      ...
      if (parent) { // 根分类
        this.crumbs.push({
          path: '/rbac/modules/index?parentId=' + parent.id,
          name: parent.name
    ...
    handleResetSearch() {
      ...
      this.$router.push({ path: '/rbac/modules/add' })
